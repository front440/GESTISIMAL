 ...
 * @author Francisco
 * 
 *         Enunciado: Escribe un programa que pida 20 números enteros. Estos
 *         números se deben introducir en un array de 4 filas por 5 columnas. El
 *         programa mostrará las sumas parciales de filas y columnas igual que
 *         si de una hoja de cálculo se tratara. La suma total debe aparecer en
