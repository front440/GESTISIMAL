...
public class TestFecha {
  public static void main(String[] args) {
    ...
    String[] fechas = {  "20191215", // correcto
        ...
        "dfdfdw",   // incorrecto
        "AAAAMMDD", // incorrecto
        "20181242", // incorrecto (diciembre no tiene 42 dÃ­as)
        "20010229", // incorrecto (no es bisiesto)
        "21000229"  // correcto (fue bisiesto)
    };
    ...
    // Comprobamos si fecha es bisiesto
    System.out.println("Prueba de esBisiesto del año " + Fecha.esBisiesto(fecha1));
    System.out.println();
    // Salida
    System.out.println("la fecha introcida es " + Fecha.fechaFormateada(fecha1));
